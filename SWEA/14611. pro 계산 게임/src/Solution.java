...
class Solution {
    ...
    private final static String name[] = {"INIT: "," PUT: "," FIND: "," CHANGE: "};
    ...
    private static boolean run() throws Exception {
        ...
        for (int q = 0; q < query_num; q++) {
                ...
                if (ans == 1) {
                    for (int i = 0; i < MAX_RET_NUM; i++) {
                        ...
                        if (ans_numbers[i] != ret_numbers[i]) {
                            for(int j=0;j<MAX_RET_NUM;j++){                                
                                System.out.print(ans_numbers[i]+" "+ret_numbers[i]+" ");
                            }
                            System.out.println();
                            ok = false;
                        }
            ...
            } else if (query == CMD_CHANGE) {call[3]++;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int tc = 1; tc <= T; tc++) {
            ...
            System.out.print("#" + tc + " " + score+" ");
            for(int i=0;i<4;i++){
                System.out.print(name[i]+call[i]);
            }
            System.out.println();
        }
