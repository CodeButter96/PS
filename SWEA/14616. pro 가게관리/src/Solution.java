		...
		for (int i = 0; i < q; ++i) {
			...
			switch (cmd) {
				...
				case CMD_BUY:
					...
					if (ret != ans){
						okay = false;
                        System.out.println("CMD_BUY ret: "+ret+" ans: "+ans);}
					break;
				case CMD_CANCEL:
					id = Integer.parseInt(st.nextToken());
					ans = Integer.parseInt(st.nextToken());
					...
					if (ret != ans){
						okay = false;
                        System.out.println("CMD_CANCEL ret: "+ret+" ans: "+ans);}
					break;
				case CMD_SELL:
					id = Integer.parseInt(st.nextToken());
					product = Integer.parseInt(st.nextToken());
					...
					if (ret != ans){
						okay = false;
                        System.out.println("CMD_SELL ret: "+ret+" ans: "+ans);}
					break;
				case CMD_REFUND:
					id = Integer.parseInt(st.nextToken());
					ans = Integer.parseInt(st.nextToken());
					...
					if (ret != ans){
						okay = false;
                        System.out.println("CMD_REFUND ret: "+ret+" ans: "+ans);}
					break;
				default:
					okay = false;
					break;
